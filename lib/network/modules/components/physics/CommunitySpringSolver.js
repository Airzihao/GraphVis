/**
 * Community Spring Solver
 */
class CommunitySpringSolver {
  /**
   * @param {Object} body
      ...
      if (edge.connected === true && edge.toId !== edge.fromId) {
        ...
        if (this.body.nodes[edge.toId] !== undefined && this.body.nodes[edge.fromId] !== undefined) {
          if (edge.edgeType.via !== undefined) {
            ...
            this._calculateSpringForce(node1, node3,  edgeLength);
          }
          else {
  ...
  _calculateSpringForce(node1, node2, edgeLength) {
    ...
    if(node1.options.group!==node2.options.group){
      springForce = 0
    }
...
export default CommunitySpringSolver;